...
*/
    @Test
    public void removeAt_given_withSomeElements_returns_withoutRemovedElement() {
        //Given - preparation
        int[] array = {1,2,3};
        CustomList list = new CustomList(array);
        //When
        int[]newArray = list.removeAt(0);
        //Then
        assertArrayEquals(new int[]{2, 3}, newArray);
}
    ...
    @Test
    public void any_given_withElement_return_true(){
        //Given - preparation
